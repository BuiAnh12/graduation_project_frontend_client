    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col justify-between flex-1 overflow-hidden">
                <div>
                    {/* --- UPDATED: Added flex container and badge --- */}
                    <div className="flex items-center justify-between">
                        <h4 className="text-red-600 text-lg font-bold line-clamp-1 truncate min-w-0">
                            {order?.stores?.name}
                        </h4>
                        
                        {/* This is the new badge */}
                        {order.isGroupOrder ? (
                            <span className="ml-2 flex-shrink-0 text-m font-semibold bg-blue-100 text-blue-800 px-4 py-1 rounded-full">
                                Đơn nhóm
                            </span>
                        ) : (
                          <span className="ml-2 flex-shrink-0 text-m font-semibold bg-green-100 text-green-800 px-4 py-1 rounded-full">
                                Đơn lẻ
                            </span>
                        )
                      }
