                        ...
                        {cart ? (
                            <div className="my-[20px]">
                                <div className="flex items-center justify-between mb-[20px]">
                                    <h3 className="text-[#4A4B4D] text-[24px] font-bold hidden md:block">
                                        Các cửa hàng đang đặt món
                                    </h3>
                                    <div
                            ...
                            <div className="flex flex-col items-center text-center py-10">
                                ...
                                <p className="text-gray-500 mt-2">
                                    Hãy chọn vài món ăn ngon ngay nào!
                                </p>
                                <Link
                                    href={`/search`}
                                    className="mt-5 px-6 py-3 bg-red-100 rounded-full shadow hover:scale-105 transition-transform text-white text-bold"
                                >
                                    Mua sắm ngay
                                </Link>
                            </div>
